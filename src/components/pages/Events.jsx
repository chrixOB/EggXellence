...
const Events = () => {
  return (
    <>
      <h1 className='mb-5 mt-5 text-center font-bold text-2xl'>Farm Events </h1>
    ...
    <div className="w-full h-16 text-2xl bg-purple-400 text-white text-center">Sawdust Change</div>
    <div className="w-full h-16 text-2xl bg-purple-400 text-white text-center">Supplements</div>
